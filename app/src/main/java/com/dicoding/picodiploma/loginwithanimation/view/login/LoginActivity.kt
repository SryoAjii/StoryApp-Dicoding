                ...
                if (result != null) {
                    when (result) {
                        ...
                        is StateResult.Success -> {
                            ...
                            repository.getToken(ApiConfig.getApiService(result.data.loginResult?.token.toString()))
                            result.data.message?.let { it1 -> toast(it1) }
                            loading(false)
                            AlertDialog.Builder(this).apply {
                                setTitle("Yeah!")
                                setMessage(R.string.loginSuccess)
                                setPositiveButton(R.string.toActivity) { _, _ ->
